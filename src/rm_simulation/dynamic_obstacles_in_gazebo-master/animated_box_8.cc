...
namespace gazebo
{
  class AnimatedBox8 : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      this->model = _parent;
        ...
        key->Translation(ignition::math::Vector3d(-6, -2, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        // set starting location of the box
        key = anim->CreateKeyFrame(2);
        key->Translation(ignition::math::Vector3d(-5, -3, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        key->Translation(ignition::math::Vector3d(-3, -1, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
  ...
  GZ_REGISTER_MODEL_PLUGIN(AnimatedBox8)
}
