...
namespace gazebo
{
  class AnimatedBox5 : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      this->model = _parent;
        ...
        key->Translation(ignition::math::Vector3d(11, -2, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        key->Translation(ignition::math::Vector3d(9, 0, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        key->Translation(ignition::math::Vector3d(9, 3, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
        // set the animation
  ...
  GZ_REGISTER_MODEL_PLUGIN(AnimatedBox5)
}
