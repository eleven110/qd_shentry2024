  ...
  class AnimatedBox3 : public ModelPlugin
  {
    public: void Load(physics::ModelPtr _parent, sdf::ElementPtr /*_sdf*/)
    {
      ...
      this->model = _parent;
        ...
        key->Translation(ignition::math::Vector3d(-2, 7, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        // set waypoint location after 2 seconds
        key = anim->CreateKeyFrame(2.0);
        key->Translation(ignition::math::Vector3d(-1, 7, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));


        key = anim->CreateKeyFrame(4.0);
        key->Translation(ignition::math::Vector3d(0, 7, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
        ...
        key->Translation(ignition::math::Vector3d(2, 8, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key = anim->CreateKeyFrame(10.0);
        key->Translation(ignition::math::Vector3d(3, 8, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
        
        key = anim->CreateKeyFrame(12.0);
        key->Translation(ignition::math::Vector3d(4, 8, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key = anim->CreateKeyFrame(14.0);
        key->Translation(ignition::math::Vector3d(5, 9, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key = anim->CreateKeyFrame(16.0);
        key->Translation(ignition::math::Vector3d(6, 9, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));

        key = anim->CreateKeyFrame(18.0);
        key->Translation(ignition::math::Vector3d(7, 8, 0));
        key->Rotation(ignition::math::Quaterniond(0, 0, 0));
        // set the animation
