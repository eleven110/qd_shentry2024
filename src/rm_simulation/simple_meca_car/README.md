...
启动动态障碍物仿真
roslaunch scene movetest_node.launch 
...
启动nmpc控制器
roslaunch auto_nav navi_simple_meca_car_nmpc.launch 


启动nmpc路径跟踪器
roslaunch auto_nav navi_simple_meca_car_mpc_controller_ros.launch 
