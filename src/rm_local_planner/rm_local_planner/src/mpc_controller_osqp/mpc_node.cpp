...
#include "lmpc_tracking/Bspline.h"
#include "std_msgs/Empty.h"

#include "lmpc_tracking/mpc.h"
...
void bsplineCallback(lmpc_tracking::BsplineConstPtr msg) {
  // parse pos traj
...
void publish_control_cmd(const ros::TimerEvent &e) {
    ...
    Eigen::Vector2d x0;
    x0 << current_state(0), current_state(1);
    ...
    //cout << "vx:" << control_cmd(0) << " " << "vy:" << control_cmd(1) << endl;
