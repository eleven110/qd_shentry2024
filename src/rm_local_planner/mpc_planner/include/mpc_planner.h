...
private:
  ...
  Eigen::Vector3d omni_mpcControl(Eigen::Vector3d s, Eigen::Vector3d s_d, Eigen::Vector3d u_r,
                                        Eigen::Vector3d du_p);
...
private:
  ...
  Eigen::Vector3d omni_du_p_;// previous omni_control error
  Eigen::Matrix3d omni_R_;     // control error matrix
